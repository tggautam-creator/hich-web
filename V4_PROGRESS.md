...
| B.3 | Instant RideConfirm companion toggle + up-to-2 multi-select + fee preview | ✅ gates green (2026-06-05) — sim build + install OK, lint clean except pre-existing RideConfirmPage length (see Known Issues; Tarun chose leave-it). Awaiting Tarun verify on sim. |
