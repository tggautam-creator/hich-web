...
export default function EmergencySheet({
  ...
  const handleShareLocation = async () => {
    ...
    try {
      ...
      const link = `https://hich.app/track/${body.token}`
      setShareLink(link)
        ...
        <div className="mt-4 rounded-2xl border border-danger bg-white shadow-2xl">
          ...
          <div className="flex flex-col gap-3 p-5">
            ...
            <a
              ...
              className="flex items-center gap-4 rounded-xl bg-danger px-5 py-4 text-white active:opacity-80 transition-opacity"
            >
            ...
            <button
              ...
              className="flex items-center gap-4 rounded-xl bg-warning px-5 py-4 text-white active:opacity-80 transition-opacity disabled:opacity-50"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 shrink-0" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              className="flex items-center gap-4 rounded-xl bg-text-primary px-5 py-4 text-white active:opacity-80 transition-opacity"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 shrink-0" viewBox="0 0 24 24" fill="currentColor">
